...
Route::delete('/enrollments4/{id}', [RevDelController::class, 'destroy']);
...
Route::get('/enrollments3/not-saved', [FetchEnrollmentController::class, 'getNotSavedEnrollments']);

Route::post('/enrollments3/{id}/save', [EnrollmentController::class, 'save']);
